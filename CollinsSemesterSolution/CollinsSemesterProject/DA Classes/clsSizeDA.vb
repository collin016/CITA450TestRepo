...
Public Class clsSizeDA
    ...
    Public Shared Function GetRecords() As DataSet
        Try
            ...
            dbDataAdapter.Fill(ds, "tblSize")

            ' return your dataset
            Return ds

        Catch ex As Exception
            MessageBox.Show("Error occured in clsSizeDA. Method: GetRecords(). Error: " & ex.Message)
            Return Nothing
        End Try
    End Function
End Class
