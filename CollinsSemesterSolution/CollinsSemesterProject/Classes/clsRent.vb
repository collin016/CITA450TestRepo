...
#Region "Class Definition"
    ...
    Public Sub New(ByVal aID As Integer, ByVal aName As String, ByVal aSize As Integer, ByVal aYear As Integer, ByVal aPrice As Double, ByVal aCust As String)
    ...
    Public Function ClassInfo() As String
        ...
        Try
            strInfo = "Board ID: " & BoardID() & vbCr _
                ...
                & "Year: " & Year() & vbCr _
                & "Price: " & Price() & vbCr _
                & "Customer: " & Customer() & vbCr
            Return strInfo
        Catch ex As Exception
            MessageBox.Show("Error occured in clsRent. Method: ClassInfo(). Error: " & ex.Message)
            Return ""
        End Try
    End Function
#End Region
    ...
    Public Shared Function GetRecords() As DataSet
        Try
            Return clsRentDA.GetRecords
        Catch ex As Exception
            MessageBox.Show("Error occured in clsRent. Method: GetRecords(). Error: " & ex.Message)
            Return Nothing
        End Try
    End Function
    ...
    Public Shared Function DeleteRecord(ByVal aPrimaryKey As String) As Integer
        Try
            Return clsRentDA.DeleteRecord(aPrimaryKey)
        Catch ex As Exception
            MessageBox.Show("Error occured in clsRent. Method: DeleteRecords(). Error: " & ex.Message)
            Return -9
        End Try
    End Function
    ...
    Public Shared Function AddRecord(ByVal aRent As clsRent) As Integer
        Try
            Return clsRentDA.AddRecord(aRent)
        Catch ex As Exception
            MessageBox.Show("Error occured in clsRent. Method: AddRecords(). Error: " & ex.Message)
            Return -9
        End Try
    End Function
    ...
    Public Shared Function UpdateRecord(ByVal aRent As clsRent) As Integer
        Try
            Return clsRentDA.UpdateRecord(aRent)
        Catch ex As Exception
            MessageBox.Show("Error occured in clsRent. Method: UpdateRecord(). Error: " & ex.Message)
            Return -9
        End Try
    End Function
    ...
    Public Shared Function SearchRecords(ByVal aRent As clsRent) As DataSet
        Try
            Return clsRentDA.SearchRecords(aRent)
        Catch ex As Exception
            MessageBox.Show("Error occured in clsRent. Method: SearchRecords(). Error: " & ex.Message)
            Return Nothing
        End Try
    End Function
End Class
